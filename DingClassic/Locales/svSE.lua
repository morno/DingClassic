...
DingClassic.Locales["svSE"] = {
    TITLE = "Ding Classic Inställningar",
    ENABLE = "Aktivera Ding Meddelanden",
    GUILD = "Skicka till Guild",
    TEST = "Testa Ding Meddelande",
    SAY = "Skicka till Say",
    DEBUG = "Aktivera Felsökningsläge",
    SAVE = "Spara Inställningar",
    SAY_DISABLED_NOTE = "Skicka till Say är tillfälligt inaktiverat och kommer förhoppningsvis att fixas i en framtida uppdatering.",
    SAVE_CONFIRMATION = "Inställningar sparade!",
    POOL_LABEL = "Välj meddelandepool:",
    LOCALE_LABEL = "Välj språk:",
    LOCALE_NOTE = "Notera: För att uppdatera titeln 'Ding Classic Inställningar' måste du skriva /reload. Detta är ett mindre problem på grund av hur Blizzard hanterar menyn för inställningar.",

    -- Message pool descriptions
    messagePoolDescriptions = {
        Default = "Standardpoolen av ding-meddelanden.",
        WoWHardCore = "Hardcore-tema ding-meddelanden för den ultimata leveling-upplevelsen.",
        WoWFunny = "Roliga och lättsamma ding-meddelanden för ett gott skratt under levelingen.",
        WoWLore = "Upptäck små historier, lore snippets och legendariska citat från Azeroths värld.",
    },
