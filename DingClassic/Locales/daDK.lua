...
DingClassic.Locales["daDK"] = {
    TITLE = "Ding Classic Indstillinger",
    ENABLE = "Aktivér Ding Beskeder",
    GUILD = "Send til Guild",
    TEST = "Test Ding Besked",
    SAY = "Send til Say",
    DEBUG = "Aktivér Debug Mode",
    SAVE = "Gem Indstillinger",
    SAY_DISABLED_NOTE = "Send til Say er midlertidigt deaktiveret og bliver forhåbentlig rettet i en fremtidig opdatering.",
    SAVE_CONFIRMATION = "Indstillinger gemt!",
    POOL_LABEL = "Vælg beskedpool:",
    LOCALE_LABEL = "Vælg sprog:",
    LOCALE_NOTE = "Bemærk: For at opdatere titlen 'Ding Classic Indstillinger' skal du skrive /reload. Dette er et mindre problem på grund af, hvordan Blizzard håndterer indstillingsmenuen.",

    -- Message pool descriptions
    messagePoolDescriptions = {
        Default = "Standardpuljen af ding-beskeder.",
        WoWHardCore = "Hardcore-tema ding-beskeder for den ultimative leveling oplevelse.",
        WoWFunny = "Sjove og lette ding-beskeder til et godt grin under levelingen.",
        WoWLore = "Oplev små historier, lore snippets og legendariske citater fra Azeroths verden.",
    },
