...
DingClassic.Locales["fiFI"] = {
    TITLE = "Ding Classic Asetukset",
    ENABLE = "Ota Ding-ilmoitukset käyttöön",
    GUILD = "Lähetä Guildiin",
    TEST = "Testaa Ding-ilmoitusta",
    SAY = "Lähetä Say-kanavalle",
    DEBUG = "Ota vianetsintätila käyttöön",
    SAVE = "Tallenna asetukset",
    SAY_DISABLED_NOTE = "Lähetä Say on väliaikaisesti poistettu käytöstä ja toivottavasti korjataan tulevassa päivityksessä.",
    AVE_CONFIRMATION = "Asetukset tallennettu!",
    POOL_LABEL = "Valitse viestipooli:",
    LOCALE_LABEL = "Valitse kieli:",
    LOCALE_NOTE = "Huomautus: Päivittääksesi otsikon 'Ding Classic -asetukset', sinun on kirjoitettava /reload. Tämä on pieni ongelma, joka johtuu siitä, miten Blizzard käsittelee asetusvalikkoa.",

    -- Message pool descriptions
    messagePoolDescriptions = {
        Default = "Oletus ding-viestien pooli.",
        WoWHardCore = "Hardcore-teemaisia ding-viestejä parasta levelöintikokemusta varten.",
        WoWFunny = "Hauskoja ja kevyitä ding-viestejä, jotka saavat sinut nauramaan levelöidessäsi.",
        WoWLore = "Löydä pieniä tarinoita, lore-pätkiä ja legendaarisia lainauksia Azerothin maailmasta.",
    },
