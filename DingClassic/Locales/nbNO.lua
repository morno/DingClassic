...
DingClassic.Locales["nbNO"] = {
    TITLE = "Ding Classic Innstillinger",
    ENABLE = "Aktiver Ding Meldinger",
    GUILD = "Send til Guild",
    TEST = "Test Ding Melding",
    SAY = "Send til Say",
    DEBUG = "Aktiver Feilsøkingsmodus",
    SAVE = "Lagre Innstillinger",
    SAY_DISABLED_NOTE = "Send til Say er midlertidig deaktivert og vil forhåpentligvis bli fikset i en fremtidig oppdatering.",
    SAVE_CONFIRMATION = "Innstillinger lagret!",
    POOL_LABEL = "Velg meldingspool:",
    LOCALE_LABEL = "Velg språk:",
    LOCALE_NOTE = "Merk: For å oppdatere tittelen 'Ding Classic Alternativer', må du skrive /reload. Dette er et mindre problem på grunn av hvordan Blizzard håndterer alternativer-menyen.",

    -- Message pool descriptions
    messagePoolDescriptions = {
        Default = "Standard samling av ding-meldinger.",
        WoWHardCore = "Hardcore-tema ding-meldinger for den ultimate leveling-opplevelsen.",
        WoWFunny = "Morsomme og lette ding-meldinger for en god latter mens du leveler.",
        WoWLore = "Oppdag små historier, lore snippets og legendariske sitater fra Azeroths verden.",
    },
