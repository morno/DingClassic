...
DingClassic.Locales["enUS"] = {
    TITLE = "Ding Classic Options",
    ENABLE = "Enable Ding Messages",
    GUILD = "Send to Guild",
    TEST = "Test Ding Message",
    SAY = "Send to Say",
    DEBUG = "Enable Debug Mode",
    SAVE = "Save Settings",
    SAY_DISABLED_NOTE = "Send to Say is temporarily disabled and will hopefully be fixed in a future update.",
    SAVE_CONFIRMATION = "Settings saved!",
    POOL_LABEL = "Select Message Pool:",
    LOCALE_LABEL = "Select Locale:",
    LOCALE_NOTE = "To update the 'Ding Classic Options' title, you need to type /reload. This is a minor issue due to how Blizzard handles the options menu.",
